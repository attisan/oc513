...
class Repeat{
	...
	public static function generate($id) {
		...
		foreach($object->getComponents() as $vevent) {
			...
			$startenddate = Object::generateStartEndDate($vevent->DTSTART, Object::getDTEndFromVEvent($vevent), ($vevent->DTSTART->getDateType() == \Sabre\VObject\Property\DateTime::DATE)?true:false, 'UTC');
