...
class OC_Connector_Sabre_CalDAV extends Sabre_CalDAV_Backend_Abstract {
	...
	public function getCalendarsForUser($principalUri) {
		$raw = OCA\Calendar\Calendar::allCalendarsWherePrincipalURIIs($principalUri);
	...
	public function createCalendar($principalUri,$calendarUri, array $properties) {
		...
		return OCA\Calendar\Calendar::addCalendarFromDAVData($principalUri,$calendarUri,$newValues['displayname'],$newValues['components'],$newValues['timezone'],$newValues['calendarorder'],$newValues['calendarcolor']);
	}
	...
	public function updateCalendar($calendarId, array $properties) {
		...
		OCA\Calendar\Calendar::editCalendar($calendarId,$newValues['displayname'],null,$newValues['timezone'],$newValues['calendarorder'],$newValues['calendarcolor']);
	...
	public function deleteCalendar($calendarId) {
		...
		OCA\Calendar\Calendar::deleteCalendar($calendarId);
	}
	...
	public function getCalendarObjects($calendarId) {
		$data = array();
		foreach(OCA\Calendar\Object::all($calendarId) as $row) {
	...
	public function getCalendarObject($calendarId,$objectUri) {
		$data = OCA\Calendar\Object::findWhereDAVDataIs($calendarId,$objectUri);
		if(is_array($data)) {
			...
			$object = OCA\Calendar\Object::cleanByAccessClass($data['id'], $object);
	...
	public function createCalendarObject($calendarId,$objectUri,$calendarData) {
		OCA\Calendar\Object::addFromDAVData($calendarId,$objectUri,$calendarData);
	}
	...
	public function updateCalendarObject($calendarId,$objectUri,$calendarData) {
		OCA\Calendar\Object::editFromDAVData($calendarId,$objectUri,$calendarData);
	}
	...
	public function deleteCalendarObject($calendarId,$objectUri) {
		OCA\Calendar\Object::deleteFromDAVData($calendarId,$objectUri);
	}
