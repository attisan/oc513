...
<div id="tabs-1">
	...
	<table width="100%">
		<tr>
			<th width="95"><?php p($l->t("Title"));?>:</th>
			<td>
	...
	<table width="100%">
		<tr>
			<th width="95"><?php p($l->t("Category"));?>:</th>
			<td>
			...
			<th width="95">&nbsp;&nbsp;&nbsp;<?php p($l->t("Calendar"));?>:</th>
			<td>
		...
		<tr>
			<th width="95"><?php p($l->t("Access Class"));?>:</th>
			<td>
	...
	<table width="100%">
		...
		<tr>
			<th width="95">&nbsp;</th>
			<td><input type="button" class="submit" value="<?php p($l->t("Advanced options")); ?>" id="advanced_options_button"></td>
		</tr>
	</table>
	...
	<div id="advanced_options" style="display: none;">
		...
		<table>
			<tr>
				<th width="95"><?php p($l->t("Location"));?>:</th>
				<td>
		...
		<table>
			<tr>
				<th width="95" style="vertical-align: top;"><?php p($l->t("Description"));?>:</th>
				<td>
					<textarea style="width:350px;height: 70px;" placeholder="<?php p($l->t("Description of the Event"));?>" name="description"><?php p(isset($_['description']) ? $_['description'] : '') ?></textarea>
				</td>
			</tr>
		</table>
	</div>
...
<div id="tabs-2">
	<table style="width:100%">
			<tr>
				<th width="95"><?php p($l->t("Repeat"));?>:</th>
				<td>
		...
		<div id="advanced_options_repeating" style="display:block;">
			<table style="width:100%">
			...
			<table style="width:100%">
				<tr id="advanced_weekday" style="display:none;">
					...
					<td id="weeklycheckbox">
						<select id="weeklyoptions" name="weeklyoptions[]" multiple="multiple" title="<?php p($l->t("Select weekdays")) ?>">
							<?php
			...
			<table style="width:100%">
				<tr id="advanced_byyearday" style="display:none;">
					...
					<td id="byyeardaycheckbox">
						...
						<select id="byyearday"  multiple="multiple"  title="<?php p($l->t("Select days")) ?>">
							<?php
						...
						<?php p($l->t('and the events day of year.')); ?>
					</td>
				</tr>
			</table>
			<table style="width:100%">
			...
			<table style="width:100%">
				<tr>
					<th width="95"><?php p($l->t('Interval')); ?>:</th>
					<td>
						<input style="width:50px;" type="number" min="1" size="4" max="1000" value="<?php p(isset($_['repeat_interval']) ? $_['repeat_interval'] : '1'); ?>" name="interval">
					</td>
				</tr>
				<tr>
					<th width="95"><?php p($l->t('End')); ?>:</th>
					<td>
