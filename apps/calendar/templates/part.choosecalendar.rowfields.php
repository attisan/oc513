...
<td width="20px">
  ...
  <a href="#" class="share action permanent" data-item-type="calendar" data-item="<?php p($_['calendar']['id']); ?>"
	...
	title="<?php p($l->t('Share Calendar')) ?>"><img class="svg" src="<?php print_unescaped(($_['shared']==false) ? OCP\Util::imagePath('core', 'actions/share.svg') : OCP\Util::imagePath('core', 'actions/shared.svg')) ?>"></a>
  <?php } ?>
</td>
<td width="20px">
<?php
